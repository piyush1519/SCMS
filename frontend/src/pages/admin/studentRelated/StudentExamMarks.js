...
const StudentExamMarks = ({ situation }) => {
    ...
    const fields = { subName: chosenSubName,examName, marksObtained }
                        ...
                        >
                            ...
                            <form onSubmit={submitHandler}>
                                <Stack spacing={3}>
                                    ...
                                    <FormControl fullWidth>
                                        <InputLabel id="demo-simple-select-label">Exam Name</InputLabel>
                                        <Select
                                            labelId="demo-simple-select-label"
                                            id="demo-simple-select"
                                            value={examName}
                                        ...
                                        >
                                            ...
                                            <MenuItem value="M.S.E.">M.S.E.</MenuItem>
